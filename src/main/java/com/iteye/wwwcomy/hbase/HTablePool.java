...
// * HTablePool and use {@link #getTable(String)} to get an HTable from the
// pool.
// * Once you are done with it, return it to the pool with {@link
// #putTable(HTableInterface)}.
// *
// * <p>A pool can be created with a <i>maxSize</i> which defines the most
// HTable
// * references that will ever be retained for each table. Otherwise the default
// * is {@link Integer#MAX_VALUE}.
// *
// * <p>Pool will manage its own cluster to the cluster. See {@link
// HConnectionManager}.
// *
// * @author greatwqs
// * @update 2012-08-25
...
// /**
// * HTableInterfaceFactory that createHTableInterface and
...
// }
//
// public HTablePool(final Configuration config, final HTableInterfaceFactory
// tableFactory) {
// // Make a new configuration instance so I can safely cleanup when
// // done with the pool.
// this.config = config == null ? new Configuration() : new
...
// * @throws Throwable
// */
// public void createHTablePool(final String tableName, final int maxSize,
// boolean isAutoFlush) throws Throwable {
...
// * usage example:
// * false: when {@link Put} use. use buffere put. call flushCommits after a
// time.
// * you can design a thread(such as 3MS run a time)to loop all pool table, and
// call flushCommits.
// * the performance well.
// * true: when {@link Scan} and {@link Delete} use.
// * @throws Throwable
// */
// public void createHTablePool(final String[] tableNameArray, final int
// maxSize, boolean isAutoFlush) throws Throwable {
