...
// * @throws Throwable
// */
// public static synchronized void deleteTable(String tableName) throws
// Throwable {
// HBaseAdmin admin = null;
// try {
// admin = getHBaseAdmin(conf); // admin = new HBaseAdmin(conf);
...
// * @throws Throwable
// */
// public static HTable getHTable(Configuration config, String tableName) throws
// Throwable{
// // 2. init HTablePool
// if (myPool==null)
...
// //if (hTablePool!=null)
// // return (HTable)
// hTablePool.getTable(tableName);//如果hTablePool对象已经存在，直接取出一个htable
// //else{ // hTablePool不存在则先new一个htablepool对象，然后再取
// // hTablePool=new HTablePool(conf,
// POOL_MAX_SIZE);//注意这个值设置的是每个htable表在pool中的最大值
...
//
// public static void putObject(String tableName, String rowKey, Serializable
// obj) throws Throwable {
// addRecord(tableName, rowKey, FAMILY, QULIFIER, obj);
// }
//
// public static Serializable getObject(String tableName, String rowKey) throws
// Throwable {
...
// }
//
// public static Serializable delObject(String tableName, String rowKey) throws
// Throwable {
...
// bytes = value == null ? EMPTY_BYTES : Bytes.toBytes(((Date)
// value).getTime());
// } else {
...
// private static void pAddRecord(String tableName, String rowKey, String
// family, String qualifier, Object value, boolean autoCreate) throws Throwable
// {
...
// table.put(put);
// table.flushCommits();
// DebugUtil.debug("insert record " + rowKey + " to table " + tableName + "
// ok.");
...
// String qualifier, Object value) throws Throwable {
...
// * @throws Throwable
// */
// public static void addRecords(String tableName, List<Put> listPut, String[]
// families) throws Throwable {
// HTable table = null;
// try {
// table = getHTable(conf, tableName);
...
// * @throws Throwable
// */
// public static Result[] getRecords(String tableName, List<Get> listGet,
// String[] families) throws Throwable {
// HTable table = null;
// try {
// table = getHTable(conf, tableName);
...
// }
//
// private static Object pDelRecord(String tableName, String rowKey, String
// family, String qualifier) throws Throwable {
...
// * @throws Throwable
// */
// public static Object delRecord(String tableName, String rowKey, String
// family, String qualifier) throws Throwable {
...
// * @throws Throwable
// */
// public static void delRecords(String tableName, List<Delete> listDelete,
// String[] families) throws Throwable {
// HTable table = null;
// try {
// table = getHTable(conf, tableName);
...
// * @throws Throwable
// */
// public static List<Object> getRecords(String tableName, String[] rowKeys,
// String family, String qualifier, boolean autoCreate) throws Throwable {
...
// }
//
// private static Object pGetOneRecord(String tableName, String rowKey, String
// family, String qualifier, boolean autoCreate) throws Throwable {
...
// * @throws Throwable
// */
// public static Object getOneRecord(String tableName, String rowKey, String
// family, String qualifier) throws Throwable {
...
// * @param allMap
// */
// public static void setOneRow(String tableName, String rowKey, Map<String,
// Map<String, byte[]>> allMap) throws Throwable {
// HTable table = null;
// try {
// if (allMap == null)
// return;
...
// put.add(Bytes.toBytes(family), Bytes.toBytes(qualifier), (byte[])
// valueMap.get(qualifier));
// }
// }
// table.put(put);
// table.flushCommits();
// DebugUtil.debug("insert records of one row " + rowKey + " to table " +
// tableName + " ok.");
// }
//// catch (org.apache.hadoop.hbase.TableNotFoundException e) {
//// DebugUtil.debug(e);
...
// public static Map<?, ?> getOneRow(String tableName, String rowKey) throws
// Throwable {
// Get get = new Get(rowKey.getBytes());
// HTable table = null;
// try {
...
// */
// @SuppressWarnings("rawtypes")
// public static Map<?, ?> delOneRow(String tableName, String rowKey) throws
// Throwable {
// HTable table = null;
// try {
// table = getHTable(conf, tableName);
...
// * @throws Throwable
// */
// public static void addMultiData(String tableName, Map<String, Map<String,
// Map<String, byte[]>>> allMap) throws Throwable {
// if (allMap.size() == 1) {
...
// * @throws Throwable
// */
// public static List<Object> delMultiData(String tableName, String[] row,
// String[] family, String[] qualifier) throws Throwable {
// if (row.length == 1)
// return delMultiData(tableName, row[0], family, qualifier);
// if (row.length > 0 && row.length == family.length && row.length ==
// qualifier.length) {
// int i = 0;
...
// }
//
// private static List<Object> delMultiData(String tableName, String row,
// String[] family, String[] qualifier) throws Throwable {
...
// * @throws Throwable
// */
// public static List<Object> getMultiData(String tableName, String[] row,
// String[] family, String[] qualifier) throws Throwable {
// List<Object> resultList = null;
// if (row.length > 0 && family.length == 1 && qualifier.length == 1) {
// resultList = getRecords(tableName, row, family[0], qualifier[0], true);
// } else if (row.length > 0 && row.length == family.length && row.length ==
// qualifier.length) {
// int i = 0;
...
// * @throws Throwable
// */
// public static List<String> findRowKey(String tableName, String[] family,
// String[] qualifier, Object[] val) throws Throwable {
// if (family.length != qualifier.length || family.length != val.length)
// return null;
// FilterList filterList = new FilterList();
// int i = 0;
// for (; i < family.length; i++) {
// filterList.addFilter(new SingleColumnValueFilter(Bytes.toBytes(family[i]),
// Bytes.toBytes(qualifier[i]),
