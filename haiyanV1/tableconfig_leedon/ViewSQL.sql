...
create or replace view V_WM_OUT as 
		...
		union all
		(
			select t_1.ID,t_1.ORDER_ID,0 as ORDER_ID_INT,t_1.MEMBER_ID,t_1.SHIP_NAME,t_1.SHIP_ADDR,t_1.SHIP_TEL,t_1.SHIP_MOBILE,t_1.FINAL_AMOUNT ,t_1.PMT_AMOUNT,t_1.COST_FREIGHT,t_1.SHIPPING,
			t_1.SHIP_AREA,t_1.ORDER_MEMO,
...
create or replace view V_WM_OUT_HISTORY as 
		...
		union all
		(
			select t_1.ID,t_1.ORDER_ID,t_1.MEMBER_ID,t_1.SHIP_NAME,t_1.SHIP_ADDR,t_1.SHIP_TEL,t_1.SHIP_MOBILE,t_1.FINAL_AMOUNT ,t_1.PMT_AMOUNT,t_1.COST_FREIGHT,t_1.SHIPPING,
			t_1.SHIP_AREA,t_1.ORDER_MEMO,
			t_1.AUDIT_TIME,t_1.OUT_TYPE,t_1.AUDIT_USER_ID,t_1.BILL_STATUS,t_1.BILL_STATUS1,t_1.WHOWNER,t_1.LOGISTICS_NAME,t_1.LOGISTICS_CODE,t_1.LOGISTICS_MEMO,t_1.HYVERSION
...
create or replace view V_WM_STOCK1 as 
	...
	(
		...
		(CASE WHEN t_1.headID=t_4.TRANS_ID THEN  t_4.WAREHOUSE WHEN t_1.WAREHOUSE is null or t_1.WAREHOUSE='' THEN t_2.WAREHOUSE ELSE t_1.WAREHOUSE END ) as WAREHOUSE,
		t_3.SUPPLIER,
		(CASE WHEN t_1.headID=t_4.TRANS_ID THEN t_4.AUDIT_TIME ELSE t_2.AUDIT_TIME END )as WM_DATE,
		(CASE WHEN t_1.headID=t_4.TRANS_ID THEN 1 ELSE -1 END) as YK ,
		t_1.BATCH,
...
create or replace view V_WM_OUT_FK_QUERY as 
		(
			select concat(t_1.ORDER_ID,'_',t_1.SUBORDERID) as ID,t_1.ORDER_ID_SUB,t_1.SUBORDERID,t_1.ORDER_ID,
			t_1.WAREHOUSE,
			t_2.OUT_TYPE,t_2.MEMBER_ID,t_2.SHIP_NAME,t_2.SHIP_ADDR,t_2.SHIP_TEL,t_2.SHIP_MOBILE,
